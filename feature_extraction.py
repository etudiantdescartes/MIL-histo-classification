...
def features_extraction(model, patches_path, extracted_features_path, batch_size):
    ...
    #array_names = [os.path.join(extracted_features_path, os.path.basename(path).split('.')[0]) + '.npy' for path in paths_array]
...
if __name__ == '__main__':
    ...
    parser.add_argument('-s', dest='source', default='patches')
    parser.add_argument('-d', dest='destination', default='features')
